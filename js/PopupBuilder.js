...
SGPBPopup.htmlCustomButton = function () {
  ...
  buttons.each(function () {
    var settings = jQuery.parseJSON(
      decodeURIComponent(jQuery(this).attr("data-options"))
    );
...
SGPBPopup.listeners = function () {
  ...
  sgAddEvent(
    window,
    "sgpbPopupBuilderAdditionalDimensionSettings",
    function (e) {
...
SGPBPopup.mobileSafariAdditionalSettings = function (e) {
  ...
  if (userAgent.match(/iPad/i) || userAgent.match(/iPhone/i)) {
    if (
      typeof popupOptions["sgpb-popup-dimension-mode"] !== "undefined" &&
      popupOptions["sgpb-popup-dimension-mode"] === "responsiveMode"
    ) {
      var openedPopupWidth = parseInt(window.innerHeight - 100);
      if (
        e.detail.popupData["sgpb-type"] === "iframe" ||
        e.detail.popupData["sgpb-type"] === "video"
      ) {
        if (
          jQuery(".sgpb-popup-builder-content-" + popupId + " iframe").length
        ) {
          jQuery(".sgpb-popup-builder-content-" + popupId).attr(
            "style",
            "height:" + openedPopupWidth + "px !important;"
          );
        }
      }
    }
...
SGPBPopup.prototype.initialsListeners = function () {
  ...
  sgAddEvent(window, "sgpbDidOpen", function (e) {
    jQuery(".sg-popup-close")
      .unbind("click")
      .bind("click", function () {
        var currentPopupId = jQuery(this)
          .parents(".sg-popup-builder-content")
          .attr("data-id");
...
SGPBPopup.prototype.getPopupIdForNextEsc = function () {
  ...
  for (var i in searchPopups) {
    ...
    if (popupData.isOpen) {
      ...
      if (
        !popupOptions["sgpb-disable-popup-closing"] &&
        popupOptions["sgpb-esc-key"]
      ) {
        popup = popupData;
        break;
      }
...
SGPBPopup.prototype.prepareOpen = function () {
  ...
  if (SGPBPopup.varToBool(popupData["sgpb-enable-close-button"])) {
    popupConfig.magicCall(
      "setCloseButtonDelay",
      parseInt(popupData["sgpb-close-button-delay"])
    );
  }

  popupConfig.magicCall(
    "setShowButton",
    SGPBPopup.varToBool(popupData["sgpb-enable-close-button"])
  );
  /* Convert seconds to micro seconds */
  var openAnimationSpeed =
    parseFloat(popupData["sgpb-open-animation-speed"]) * 1000;
  var closeAnimationSpeed =
    parseFloat(popupData["sgpb-close-animation-speed"]) * 1000;
  popupConfig.magicCall(
    "setOpenAnimationEffect",
    popupData["sgpb-open-animation-effect"]
  );
  popupConfig.magicCall(
    "setCloseAnimationEffect",
    popupData["sgpb-close-animation-effect"]
  );
  ...
  popupConfig.magicCall(
    ...
    popupData["sgpb-open-animation"]
  );
  popupConfig.magicCall(
    "setCloseAnimationStatus",
    popupData["sgpb-close-animation"]
  );
  ...
  popupConfig.magicCall(
    "setCloseButtonWidth",
    popupData["sgpb-button-image-width"]
  );
  popupConfig.magicCall(
    "setCloseButtonHeight",
    popupData["sgpb-button-image-height"]
  );
  popupConfig.magicCall("setPopupId", popupId);
  popupConfig.magicCall("setPopupData", popupData);
  popupConfig.magicCall(
    "setAllowed",
    !SGPBPopup.varToBool(popupData["sgpb-disable-popup-closing"])
  );
  ...
  popupConfig.magicCall(
    "setEscShouldClose",
    SGPBPopup.varToBool(popupData["sgpb-esc-key"])
  );
  popupConfig.magicCall(
    "setOverlayShouldClose",
    SGPBPopup.varToBool(popupData["sgpb-overlay-click"])
  );

  popupConfig.magicCall(
    "setScrollingEnabled",
    SGPBPopup.varToBool(popupData["sgpb-enable-content-scrolling"])
  );
  ...
  sgAddEvent(window, "sgpbWillOpen", function (e) {
    if (
      ...
      e.detail.popupData["sgpb-content-click"] == "undefined"
    ) {
      return false;
    }
  ...
  popupConfig.magicCall(
    "setContents",
    document.getElementById("sg-popup-content-wrapper-" + popupId)
  );
...
SGPBPopup.prototype.forceCheckCurrentPopupType = function (popupObj) {
  ...
  if (
    typeof SGPB_POPUP_PARAMS.conditionalJsClasses != "undefined" &&
    SGPB_POPUP_PARAMS.conditionalJsClasses.length
  ) {
  ...
  className =
    popupConfig.prefix.toUpperCase() + PopupConfig.firstToUpperCase(className);
...
SGPBPopup.prototype.checkCurrentPopupType = function () {
  ...
  var dontShowPopupCookieName =
    "sgDontShowPopup" + this.popupData["sgpb-post-id"];
...
SGPBPopup.prototype.setPopupLimitationCookie = function (popupData) {
  ...
  var popupShowingLimitExpiry = parseInt(
    popupData["sgpb-show-popup-same-user-expiry"]
  );

  SGPBPopup.setCookie(
    cookieData.cookieName,
    JSON.stringify(cookie),
    popupShowingLimitExpiry,
    currentUrl
  );
};
...
SGPBPopup.prototype.isSatistfyForShowingLimitation = function (popupData) {
  ...
  return (
    popupData["sgpb-show-popup-same-user-count"] >
    cookieData.cookie.openingCount
  );
};
...
SGPBPopup.prototype.getPopupShowLimitationCookieDetails = function (popupData) {
  ...
  /*Cookie names*/
  var popupLimitationCookieHomePageLevelName =
    "SGPBShowingLimitationHomePage" + currentPopupId;
  var popupLimitationCookiePageLevelName =
    "SGPBShowingLimitationPage" + currentPopupId;
  var popupLimitationCookieDomainName =
    "SGPBShowingLimitationDomain" + currentPopupId;

  var pageLevelCookie =
    popupData["sgpb-show-popup-same-user-page-level"] || false;

  /*check if current url is home page*/
  if (currentUrl == SGPB_POPUP_PARAMS.homePageUrl) {
    popupLimitationCookiePageLevelName = popupLimitationCookieHomePageLevelName;
  }
  var popupLimitationPageLevelCookie = SGPopup.getCookie(
    popupLimitationCookiePageLevelName
  );
  var popupLimitationDomainCookie = SGPopup.getCookie(
    popupLimitationCookieDomainName
  );
...
SGPBPopup.prototype.themeCreator = function () {
  ...
  popupConfig.magicCall(
    "setOverlayAddClass",
    popupTheme + "-overlay sgpb-popup-overlay-" + popupId
  );
  popupConfig.magicCall(
    "setContentAddClass",
    "sgpb-content sgpb-content-" +
      popupId +
      " " +
      popupTheme +
      "-content " +
  ...
  if (
    typeof popupData["sgpb-close-button-position"] == "undefined" ||
    popupData["sgpb-close-button-position"] == ""
  ) {
    /*
  ...
  if (popupTheme == "sgpb-theme-1") {
    ...
    popupConfig.magicCall(
      ...
      popupData["sgpb-border-radius"]
    );
    popupConfig.magicCall(
      "setContentBorderRadiusType",
      popupData["sgpb-border-radius-type"]
    );
    popupConfig.magicCall(
      "setContentBorderColor",
      popupData["sgpb-border-color"]
    );
  ...
  if (!popupData["sgpb-button-image"]) {
    ...
    popupConfig.magicCall(
      "setButtonImage",
      "data:image/png;base64," + popupData["sgpb-button-image-data"]
    );
    if (
      popupData["sgpb-button-image-data"] == "" ||
      popupData["sgpb-button-image-data"].indexOf("http") != -1
    ) {
...
SGPBPopup.prototype.themeCustomizations = function () {
  ...
  if (popupData["sgpb-background-image-data"]) {
    var contentBgImage =
      "data:image/png;base64," + popupData["sgpb-background-image-data"];
  } else {
  ...
  if (SGPB_JS_PACKAGES.extensions["advanced-closing"]) {
    if (
      typeof popupData["sgpb-enable-popup-overlay"] != "undefined" &&
      popupData["sgpb-enable-popup-overlay"] == "on"
    ) {
  ...
  popupConfig.magicCall(
    "setOverlayVisible",
    SGPBPopup.varToBool(popupData["sgpb-enable-popup-overlay"])
  );
  if (typeof SgpbRecentSalesPopupType != "undefined") {
    popupConfig.magicCall("setOverlayVisible", false);
  }
  if (SGPBPopup.varToBool(popupData["sgpb-enable-popup-overlay"])) {
    popupConfig.magicCall(
      "setOverlayAddClass",
      overlayClasses + " " + popupData["sgpb-overlay-custom-class"]
    );
...
SGPBPopup.prototype.formSubmissionDetection = function (args) {
  ...
  jQuery(".sgpb-popup-builder-content-" + popupId + " form").submit(
    function () {
...
SGPBPopup.prototype.htmlIframeFilterForOpen = function (
  popupId,
  popupEventName
) {
...
SGPBPopup.prototype.iframeSizesInHtml = function (args) {
  ...
  popupContent.find("iframe").each(function () {
    ...
    if (popupOptions["sgpb-popup-dimension-mode"] == "customMode") {
      if (
        typeof jQuery(this).attr("width") == "undefined" &&
        typeof popupContent.attr("height") == "undefined"
      ) {
        jQuery(this).css({
          width: popupOptions["sgpb-width"],
          height: popupOptions["sgpb-height"],
        });
      }
    }
  });
...
SGPBPopup.prototype.replaceWithCustomShortcode = function (popupId) {
  ...
  for (var index in searchData) {
    ...
    if (
      typeof searchAttributes["selector"] == "undefined" ||
      typeof searchAttributes["attribute"] == "undefined"
    ) {
    ...
    if (searchAttributes["attribute"] == "text") {
      ...
      var replaceName = jQuery(searchAttributes["selector"]).attr(
...
SGPBPopup.prototype.replaceShortCode = function (
  shortCode,
  replaceText,
  popupId
) {
...
SGPBPopup.prototype.popupTriggeringListeners = function () {
  ...
  sgAddEvent(window, "sgpbDidOpen", function (e) {
    ...
    if (closeButtonDelay) {
      that.closeButtonDisplay(
        popupOptions["sgpb-post-id"],
        "show",
        closeButtonDelay
      );
    }
...
SGPBPopup.prototype.sgpbDontShowPopup = function (popupId) {
  var dontShowPopup = jQuery(".sgpb-content-" + popupId)
    .parent()
    .find('[class*="sg-popup-dont-show"]');
  ...
  dontShowPopup.each(function () {
    jQuery(this).bind("click", function (e) {
      ...
      var classNameSearch = jQuery(this)
        .attr("class")
        .match(/sg-popup-dont-show/);
...
SGPBPopup.prototype.addToCounter = function (popupOptions) {
  if (
    SGPB_POPUP_PARAMS.isPreview ||
    typeof popupOptions["sgpb-popup-counting-disabled"] != "undefined"
  ) {
    return false;
  }
  var that = this;
...
SGPBPopup.prototype.findTargetInsideExceptionsList = function (
  targetName,
  exceptionList
) {
  var status = false;
  var popupContentMainDiv = document.getElementById(
...
SGPBPopup.prototype.contentCloseBehavior = function () {
  ...
  var redirectToNewTab = SGPBPopup.varToBool(
    popupData["sgpb-redirect-to-new-tab"]
  );
  var closePopupAfterCopy = SGPBPopup.varToBool(
    popupData["sgpb-copy-to-clipboard-close-popup"]
  );
  var clipboardAlert = SGPBPopup.varToBool(
    popupData["sgpb-copy-to-clipboard-alert"]
  );
  ...
  sgAddEvent(window, "sgpbWillOpen", function (e) {
    ...
    jQuery(".sgpb-content-" + e.detail.popupId).on("click", function (event) {
      ...
      if (contentClickBehavior == "redirect") {
        ...
        var parentsIsInExceptionsList = that.findTargetInsideExceptionsList(
          event.target,
          exceptionList
        );
        ...
        if (
          exceptionList.indexOf(targetName) == -1 &&
          !parentsIsInExceptionsList
        ) {
...
SGPBPopup.prototype.setPopupDimensions = function () {
  ...
  if (dimensionData == "responsiveMode") {
    ...
    if (dimensionMeasure != "auto") {
      ...
      var widthToSet =
        jQuery(".sgpb-popup-builder-content-" + popupId).width() +
        contentPadding * 2;
...
SGPBPopup.closePopupById = function (popupId) {
  ...
  for (var i in popupObjs) {
    ...
    if (currentObj.popupId == popupId) {
      ...
      if (popupObj) {
        /*Send true argument to donâ€™t count disable popup option*/
        popupObj.close(true);
      }
    }
  }
...
SGPBPopup.offPopup = function (currentPopup) {
  ...
  for (var i in popups) {
    ...
    if (
      popupData.order == currentPopup.order &&
      popupData.eventName == currentPopup.eventName
    ) {
...
SGPBPopup.setCookie = function (cName, cValue, exDays, cPageLevel) {
  ...
  if (exDays == "session") {
    ...
    expirationDate.setDate(
      parseInt(expirationDate.getDate() + parseInt(exDays))
    );
  ...
  var value =
    ...
    (exDays == null
      ? ";"
      : "; " + expires + ";" + cookiePageLevel + "; SameSite=" + sameSite);
...
SgpbEventListener.prototype.timerIncrement = function (
  listenerObj,
  idleInterval
) {
...
SgpbEventListener.prototype.sgpbInsideclick = function (
  listenerObj,
  eventData
) {
  sgAddEvent(window, "sgpbDidOpen", function (e) {
    ...
    targetClick.each(function () {
      jQuery(this)
        .unbind("click")
        .bind("click", function () {
          var dontCloseCurrentPopup = jQuery(this).attr(
            "dontCloseCurrentPopup"
          );
          if (
            typeof dontCloseCurrentPopup == "undefined" ||
            dontCloseCurrentPopup != "on"
          ) {
            SGPBPopup.closePopup();
          }
          popupObj.prepareOpen();
...
SgpbEventListener.prototype.sgpbClick = function (listenerObj, eventData) {
  ...
  for (var key in popupIds) {
    ...
    if (
      typeof eventData.operator != "undefined" &&
      eventData.operator == "clickActionCustomClass"
    ) {
      targetClick = jQuery(
        'a[href*="#sg-popup-id-' +
          popupId +
...
SgpbEventListener.prototype.sgpbHover = function (listenerObj, eventData) {
  ...
  for (var key in popupIds) {
    ...
    if (
      typeof eventData.operator != "undefined" &&
      eventData.operator == "hoverActionCustomClass"
    ) {
      hoverSelector = jQuery(
        ".sg-popup-hover-" +
          popupId +
          ", .sgpb-popup-id-" +
          popupId +
...
SgpbEventListener.findCF7InPopup = function (popupId) {
  return document.querySelector(
    "#sg-popup-content-wrapper-" + popupId + " .wpcf7"
  );
};
    ...
    wpcf7Elm.addEventListener(
      ...
      function (event) {
        ...
        if (options["operator"] == "close-popup") {
          ...
          SGPBPopup.closePopupById(popupId);
          var popupObj = SGPBPopup.createPopupObjById(
            Object.keys(options["value"])[0]
          );
          popupObj.prepareOpen();
        }
      },
