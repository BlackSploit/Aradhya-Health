jQuery(document).ready(function () {
  ...
  jQuery(window).on("load resize", function (e) {
    if (jQuery(window).width() <= "1024") {
      jQuery(
        "#zita-menu a,#zita-above-menu a,.menu-btn-btm a,#menu-all-pages a"
      ).attr("tabindex", "-1");
    }
  });
  // close-button-active
  if (
    ...
    jQuery("body")
      .find(".sider")
      .prepend(
        '<div class="menu-close"><span tabindex="0" class="menu-close-btn"></span></div>'
      );
    jQuery(".menu-close-btn").removeAttr("href");
    //Menu close
    jQuery(".menu-close-btn,.zita-menu li a span.zita-menu-link").click(
      function () {
    ...
    jQuery(".menu-close-btn,.zita-menu li a span.zita-menu-link").keypress(
      function () {
        jQuery("body").removeClass("mobile-menu-active");
        jQuery("body").removeClass("mobile-above-menu-active");
        jQuery("body").removeClass("mobile-bottom-menu-active");
    ...
    document.addEventListener(
      ...
      function (event) {
        if (event.keyCode === 27) {
          ...
          document.querySelectorAll(".mobile-menu-active").forEach(
            function (element) {
              jQuery("body").removeClass("mobile-menu-active");
            }.bind(this)
          );
          document.querySelectorAll(".mobile-above-menu-active").forEach(
            function (element) {
              jQuery("body").removeClass("mobile-above-menu-active");
            }.bind(this)
          );
          document.querySelectorAll(".mobile-bottom-menu-active").forEach(
            function (element) {
              jQuery("body").removeClass("mobile-bottom-menu-active");
            }.bind(this)
          );
  ...
  if (jQuery("#back-to-top").val() == "on") {
    jQuery("body").prepend(
      "<a id='move-to-top' class='animate' href='#'><img src='./up1.png'/ width=30vw></a>"
    );
  ...
  (function (jQuery) {
    ...
    jQuery(document).ready(function () {
      ...
      if ($wpAdminBar.length) {
        jQuery("header.mhdrleftpan,header.mhdrrightpan").css(
          "margin-top",
          $wpAdminBar.height() + "px"
        );
      }
    });
  })(jQuery);
  ...
  /**************************************************/
  jQuery(
    "header.mhdrleftpan .cart-contents,header.mhdrrightpan .cart-contents,header.mhdminbarleft .cart-contents,header.mhdminbarright .cart-contents,header.mhdminbarbtm .cart-contents"
  ).click(function (e) {
    e.preventDefault();
    jQuery("body").toggleClass("cart-pan-active");
    jQuery("body")
      .find(".zita-cart")
      .prepend('<div class="cart-close"><a class="cart-close-btn"></a></div>');
...
/**************************************************/
if (
  jQuery("header.zta-above-stick-hdr").length != "" ||
  jQuery("header.zta-main-stick-hdr").length != "" ||
  jQuery("header.zta-bottom-stick-hdr").length != ""
) {
  if (jQuery("#header-scroll-down-hide").val() == "on") {
    ...
    var $bottomheader = jQuery(
      "header.zta-main-stick-hdr .bottom-header"
    ).height();
    ...
    jQuery(window).scroll(function () {
      ...
      if (scroll > position || scroll < $headerBar) {
        jQuery(
          "header.zta-above-stick-hdr,header.zta-main-stick-hdr,header.zta-bottom-stick-hdr"
        ).removeClass("shrink");
    ...
    jQuery(document).on("scroll", function () {
      var $headerBar = jQuery("header").height();
      var $mainheader = jQuery(
        "header.zta-main-stick-hdr .main-header"
      ).height();
      var $topheader = jQuery("header.zta-main-stick-hdr .top-header").height();
      var $bottomheader = jQuery(
        "header.zta-main-stick-hdr .bottom-header"
