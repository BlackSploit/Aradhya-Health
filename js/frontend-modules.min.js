  ...
  [354],
  {
      ...
      class NestedAccordion extends i.default {
        ...
        getDefaultElements() {
          ...
          return {
            ...
            $items: this.findElement(e.accordionItems),
          };
        }
        onInit() {
          super.onInit(...arguments),
        ...
        interlaceContainers() {
          const { $contentContainers: e, $items: t } =
    ...
    7323: (e, t, n) => {
      ...
      class NestedTabs extends i.default {
        ...
        bindEvents() {
          this.elements.$tabTitles.on(this.getTabEvents()),
            ...
            (this.resizeListenerNestedTabs =
              this.setHorizontalScrollAlignment.bind(this)),
        ...
        changeScrollStatus(e) {
          const t = this.elements.$headingContainer[0];
          "mousedown" === e.type
            ? (t.classList.add("e-scroll"), (t.dataset.pageX = e.pageX))
            : (t.classList.remove("e-scroll"),
              t.classList.remove("e-scroll-active"),
              (t.dataset.pageX = ""));
        }
        isHorizontalScroll() {
          const e = this.elements.$headingContainer[0];
          return (
            e.clientWidth < this.getChildrenWidth(e.children) &&
            "enable" === this.getHorizontalScrollSetting()
          );
        }
        getChildrenWidth(e) {
          let t = 0;
        ...
        setHorizontalScrollAlignment() {
          ...
          if (this.isHorizontalScroll()) {
            const t = this.getTabsDirection();
            this.initialScrollPosition(e, t);
          } else e.style.setProperty("--n-tabs-heading-justify-content", "");
        }
        getTabsDirection() {
        ...
        initialScrollPosition(e, t) {
          const n = elementorCommon.config.isRTL;
          if ("end" === t)
            e.style.setProperty("--n-tabs-heading-justify-content", "start"),
              (e.scrollLeft = n
                ? -1 * this.getChildrenWidth(e.children)
                : this.getChildrenWidth(e.children));
          else
            e.style.setProperty("--n-tabs-heading-justify-content", "start"),
              (e.scrollLeft = 0);
        }
        ...
        setHorizontalTabTitleScrollValues(e) {
          const t = this.elements.$headingContainer[0],
            n = t.classList.contains("e-scroll"),
            r = "enable" === this.getHorizontalScrollSetting(),
            i = t.scrollWidth > t.clientWidth;
          if (!n || !r || !i) return;
          e.preventDefault();
          const s = parseFloat(t.dataset.pageX),
            o = e.pageX - s;
          let a = 0;
          (a = 20 < o ? 5 : -20 > o ? -5 : o),
            (t.scrollLeft = t.scrollLeft - a),
            t.classList.add("e-scroll-active");
        }
      }
